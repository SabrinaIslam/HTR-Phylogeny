...
# motif plots 
  ...
  ggsave(file="output/p1pot.pdf", width = 210, height = 297, units = "mm")
  ...
  ggsave(file="output/p2pot.pdf", width = 210, height = 297, units = "mm")
  ...
  ggsave(file="output/p3pot.pdf", width = 210, height = 297, units = "mm")
