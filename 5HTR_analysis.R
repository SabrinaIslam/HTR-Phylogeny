...
# motif plots 
  ...
  p1plot <- plot_grid(HTR1A_motif_plot, HTR1B_motif_plot,
                      HTR1D_motif_plot, HTR1E_motif_plot,
                      HTR1F_motif_plot, HTR1A_motif_plot,
                      labels = c("A", "B", "C", "D", "E", "F"),
                      ncol = 2, nrow = 3)
  
  p1plot
  
  ggsave(file="output/p1plot.pdf", width = 210, height = 297, units = "mm")
  
  
  p2plot <- plot_grid(HTR2A_motif_plot,
                      HTR2B_motif_plot, 
                      HTR2C_motif_plot,
                      HTR6_motif_plot,
                      labels = c("A", "B", "C", "D"),
  ...
  ggsave(file="output/p2plot.pdf", width = 210, height = 297, units = "mm")
  
  
  p3plot <- plot_grid(HTR4_motif_plot,
                      HTR7_motif_plot,
                      labels = c("A", "B"),
                      ncol = 1, nrow = 2)
  ...
  ggsave(file="output/p3plot.pdf", width = 210, height = 297, units = "mm")
  
# conservation
  
  allpa_plot <- plot_grid(con_1, con_2_new, con_3, 
                          labels = c("A", "B", "C"),
                          ncol = 1)
  
  allpa_plot
  
  ggsave("output/allpa_plot.pdf", width = 210, height = 297, units = "mm")
